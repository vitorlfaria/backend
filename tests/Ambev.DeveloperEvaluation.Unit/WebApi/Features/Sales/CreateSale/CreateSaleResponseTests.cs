...
/// <summary>
/// Contains unit tests for the CreateSaleResponse class.
/// Tests cover response creation and property assignment.
/// </summary>
public class CreateSaleResponseTests
{
    /// <summary>
    /// Tests that the CreateSaleResponse is created with the correct properties.
    /// </summary>
    [Fact(DisplayName = "CreateSaleResponse should be created with the correct properties")]

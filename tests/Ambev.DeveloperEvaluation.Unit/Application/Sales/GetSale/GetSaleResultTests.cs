...
/// <summary>
/// Contains unit tests for the GetSaleResult class.
...
public class GetSaleResultTests
{
    ...
    public void Given_GetSaleResult_When_IdIsSet_Then_IdShouldBeCorrect()
    {
        // Arrange
        var id = Guid.NewGuid();
    ...
    public void Given_GetSaleResult_When_NumberIsSet_Then_NumberShouldBeCorrect()
    {
        // Arrange
        var number = 123;

        // Act
        var result = new GetSaleResult { Number = number };
    ...
    public void Given_GetSaleResult_When_SaleDateIsSet_Then_SaleDateShouldBeCorrect()
    {
        // Arrange
        var saleDate = DateTime.UtcNow;

        // Act
        var result = new GetSaleResult { SaleDate = saleDate };

        // Assert
        Assert.Equal(saleDate, result.SaleDate);
    }

    // You can add more tests here to cover other properties of GetSaleResult,
    // such as CustomerId, TotalAmount, BranchId, and Canceled.
    // [Fact(DisplayName = "CustomerId property should be initialized correctly")]
    // public void Given_GetSaleResult_When_CustomerIdIsSet_Then_CustomerIdShouldBeCorrect() { /* ... */ }
    // [Fact(DisplayName = "TotalAmount property should be initialized correctly")]
    // public void Given_GetSaleResult_When_TotalAmountIsSet_Then_TotalAmountShouldBeCorrect() { /* ... */ }
    // [Fact(DisplayName = "BranchId property should be initialized correctly")]
    // public void Given_GetSaleResult_When_BranchIdIsSet_Then_BranchIdShouldBeCorrect() { /* ... */ }
    // [Fact(DisplayName = "Canceled property should be initialized correctly")]
    // public void Given_GetSaleResult_When_CanceledIsSet_Then_CanceledShouldBeCorrect() { /* ... */ }
}